...
public:
    ...
    static const inline string COURSE_MIN = "1";
    static const inline string COURSE_MAX = "4";
    static const unsigned int WATER_DEFAULT = 1;
    static const inline vector<unsigned int> DATA_DEFAULT = {1, 1, 2000};
    static const inline vector<string> STUDENT_DEFAULT = {"FirstName", "LastName", "Patronymic", "1"};
    Note();
    Note(const vector<unsigned int>& dataInfo, const vector<string>& studentInfo, const double waterNumber);
